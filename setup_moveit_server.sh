...
echo "cp ~/chameleon/so_arm100.urdf $SRC_DIR/urdf/"
echo "cp ~/chameleon/moveit_config/so_arm100.srdf $SRC_DIR/config/"
echo "cp -r ~/chameleon/assets/* $SRC_DIR/assets/"

echo ""
echo "=== Workflow for Isaac Sim + MoveIt ==="
echo "Terminal 1 (Move_Group):"
echo "  source install/setup.bash && ros2 launch so100_moveit_config move_group.launch.py"
echo ""
echo "Terminal 2 (Bridge Server - requires system python):"
echo "  python3 ~/chameleon/moveit_ros_server.py"
echo ""
echo "Terminal 3 (Isaac Sim):"
echo "  ~/isaacsim/python.sh collect_data.py --episodes 1"
