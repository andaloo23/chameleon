...
class PickPlaceEnvCfg(DirectRLEnvCfg):
    ...
    rew_grip_open_near           = 0.1     # per-step reward for open gripper (>0.5) within 10cm of cube — nudge only
    rew_grip_close               = 2.0     # per-step reward for gripper in contact range (0.20–0.60) within 5cm
